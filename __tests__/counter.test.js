...
describe ('counter', () => {
  ...
  test('should return number of quarters, dimes, nickels, & pennies in coinage', () => {
    const count = counter(1.17);
    expect(count).toEqual("4 quarters, 1 dimes, 1 nickels, 2 pennies, & none");
  });
